...
public:
	...
	[[nodiscard]] const std::string& getParameter(const std::string& name) const;
	...
	[[nodiscard]] const NameValueCollection& parameters() const;
	...
	[[nodiscard]] bool matches(const MediaType& mediaType) const;
		/// Returns true iff the type and subtype match
		/// the type and subtype of the given media type.
		/// Matching is case insensitive.

	[[nodiscard]] bool matches(const std::string& type, const std::string& subType) const;
		/// Returns true iff the type and subtype match
		/// the given type and subtype.
		/// Matching is case insensitive.

	[[nodiscard]] bool matches(const std::string& type) const;
		/// Returns true iff the type matches the given type.
		/// Matching is case insensitive.

	[[nodiscard]] bool matchesRange(const MediaType& mediaType) const;
	...
	[[nodiscard]] bool matchesRange(const std::string& type, const std::string& subType) const;
		/// Returns true if the type and subtype match
		/// the given type and subtype.
		/// If the MIME type is a range of types it matches
		/// any media type within the range (e.g. "image/*" matches
	...
	[[nodiscard]] bool matchesRange(const std::string& type) const;
