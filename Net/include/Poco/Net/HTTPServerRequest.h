...
public:
	...
	[[nodiscard]] virtual const SocketAddress& clientAddress() const = 0;
		/// Returns the client's address.

	[[nodiscard]] virtual const SocketAddress& serverAddress() const = 0;
		/// Returns the server's address.

	[[nodiscard]] virtual const HTTPServerParams& serverParams() const = 0;
		/// Returns a reference to the server parameters.

	[[nodiscard]] virtual HTTPServerResponse& response() const = 0;
