...
// SNMPEventArgs.h
//
// $Id: //poco/1.4/NetEx/include/Poco/Net/SNMPEventArgs.h#1 $
//
// Library: NetEx
// Package: SNMP
...
#ifndef NetEx_SNMPEventArgs_INCLUDED
#define NetEx_SNMPEventArgs_INCLUDED
...
public:
	...
	Poco::ASN::ASN1::Ptr rawMessage() const;
...
private:
	...
	void setRawMessage(Poco::ASN::ASN1::Ptr rawmessage);
	void setError(const std::string &error);

	SocketAddress _address;
	int _requestid;
	SNMPTypes::SNMPMessage::Ptr _message;
	Poco::ASN::ASN1::Ptr _rawmessage;
	std::string _error;
	bool _abort;
...
#endif // NetEx_SNMPEventArgs_INCLUDED
