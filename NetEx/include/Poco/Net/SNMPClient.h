...
// SNMPClient.h
//
// $Id: //poco/1.4/NetEx/include/Poco/Net/SNMPClient.h#1 $
//
// Library: NetEx
// Package: SNMP
// Module:  SNMPClient
...
#ifndef NetEx_SNMPClient_INCLUDED
#define NetEx_SNMPClient_INCLUDED
...
public:
	...
	void set(SocketAddress& address, const std::string &oid, ASN::ASN1::Ptr value, int requestId = 0, 
		const std::string &community = "public",
		SNMPVersion::Version version = SNMPVersion::SNMPv1);
		/// Sends a SNMP SET request for a single value.
		/// Notifications are posted for events.

	void set(const std::string& address, const std::string &oid, ASN::ASN1::Ptr value, int requestId = 0,
		const std::string &community = "public",
		SNMPVersion::Version version = SNMPVersion::SNMPv1);
...
#endif // NetEx_SNMPClient_INCLUDED
