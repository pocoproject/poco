...
// SNMPEventArgs.cpp
//
// $Id: //poco/1.4/NetEx/src/SNMPEventArgs.cpp#1 $
//
// Library: NetEx
// Package: SNMP
...
Poco::ASN::ASN1::Ptr SNMPEventArgs::rawMessage() const
{
	return _rawmessage;
}
...
void SNMPEventArgs::setRawMessage(Poco::ASN::ASN1::Ptr rawmessage)
{
