...
//
// $Id: //poco/1.4/NetEx/src/SNMPClientRawTypes.cpp#1 $
//
// Library: NetEx
// Package: SNMP
...
IPAddress::IPAddress() : Poco::ASN::ASN1Types::OctetString(SNMP_ASN1::IPAddress)
{

}


IPAddress::IPAddress(const std::string &value) : Poco::ASN::ASN1Types::OctetString(SNMP_ASN1::IPAddress, value)
{

}


IPAddress::IPAddress(ASN::ASN1Type type, const std::string &value) : Poco::ASN::ASN1Types::OctetString(type, value)
{
