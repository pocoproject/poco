...
// SNMPClientTypes.cpp
//
// $Id: //poco/1.4/NetEx/src/SNMPClientTypes.cpp#1 $
//
// Library: NetEx
// Package: SNMP
...
VarBind::VarBind(ASN::ASN1::Ptr data) : Poco::RefCountedObject()
{
	decode(data);
}


VarBind::VarBind(const std::string oid, ASN::ASN1::Ptr value) :
...
ASN::ASN1::Ptr VarBind::value() const
{
	return _value;
}


void VarBind::setValue(ASN::ASN1::Ptr value)
{
	_value = value;
}


void VarBind::decode(ASN::ASN1::Ptr data)
{
	if (data->getType().universalValue() != ASN::ASN1Type::Sequence)
	...
	if (seq->getSequenceData()[0]->getType().universalValue() != ASN::ASN1Type::ObjectIdentifier)
...
ASN::ASN1::Ptr VarBind::encode()
{
	Poco::ASN::ASN1Types::SequenceData seqdata;
	seqdata.push_back(new ObjectIdentifier(_oid));
	seqdata.push_back(_value);
	return ASN::ASN1::Ptr(new Sequence(seqdata));
}
...
VarBindList::VarBindList(ASN::ASN1::Ptr data) : Poco::RefCountedObject()
{
	decode(data);
}
...
void VarBindList::decode(ASN::ASN1::Ptr data)
{
	_list.clear();
...
ASN::ASN1::Ptr VarBindList::encode()
{
	Poco::ASN::ASN1Types::SequenceData seqdata;
...
PDU::PDU() : 
	Poco::RefCountedObject(), _type(ASN::ASN1Type(ASN::ASN1Type::Sequence, true)), _requestid(0), _error(0), _errorindex(0)
{

}


PDU::PDU(ASN::ASN1::Ptr data) : 
	Poco::RefCountedObject(), _type(ASN::ASN1Type(ASN::ASN1Type::Sequence, true)), _requestid(0), _error(0), _errorindex(0)
{
	decode(data);
}
...
const ASN::ASN1Type &PDU::type() const
{
	return _type;
}


void PDU::setType(const ASN::ASN1Type &value)
{
	_type = value;
}
...
void PDU::decode(ASN::ASN1::Ptr data)
{
	_varbindlist.clear();
	...
	if (seq->getSequenceData()[0]->getType().universalValue() != ASN::ASN1Type::Integer ||
		seq->getSequenceData()[1]->getType().universalValue() != ASN::ASN1Type::Integer ||
		seq->getSequenceData()[2]->getType().universalValue() != ASN::ASN1Type::Integer ||
		seq->getSequenceData()[3]->getType().universalValue() != ASN::ASN1Type::Sequence)
		throw Poco::DataException("Invalid VarBind data format");
...
ASN::ASN1::Ptr PDU::encode()
{
	...
	return ASN::ASN1::Ptr(new Sequence(_type, seqdata));
}
...
SNMPMessage::SNMPMessage(ASN::ASN1::Ptr data) : Poco::RefCountedObject()
{
	decode(data);
}
...
void SNMPMessage::decode(ASN::ASN1::Ptr data)
{
	if (data->getType().universalValue() != ASN::ASN1Type::Sequence)
	...
	if (seq->getSequenceData()[0]->getType().universalValue() != ASN::ASN1Type::Integer ||
		seq->getSequenceData()[1]->getType().universalValue() != ASN::ASN1Type::OctetString)
...
ASN::ASN1::Ptr SNMPMessage::encode()
{
	Poco::ASN::ASN1Types::SequenceData seqdata;
