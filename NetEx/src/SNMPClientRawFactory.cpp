...
//
// $Id: //poco/1.4/NetEx/src/SNMPClientRawFactory.cpp#1 $
//
// Library: NetEx
// Package: SNMP
...
ASN::ASN1::Ptr SNMPClientRawFactory::create(ASN::ASN1Type type)
{
	if (type.aclass() == ASN::ASN1Type::Application)
	{
	...
	else if (type.aclass() == ASN::ASN1Type::ContextSpecific)
	{
		switch (type.rawValue())
		{
		...
		case SNMP_ASN1::GetResponsePDU:
			return new Poco::ASN::ASN1Types::Sequence(type);
		}
	}
