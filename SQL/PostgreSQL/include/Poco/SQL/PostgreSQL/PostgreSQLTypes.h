...
{
public:
    explicit InputParameter(Poco::SQL::MetaColumn::ColumnDataType	aFieldType,
							const void*								aDataPtr,
    ...
    Poco::SQL::MetaColumn::ColumnDataType	fieldType() const;
...
private:
    Poco::SQL::MetaColumn::ColumnDataType	_fieldType;
    const void*								_pData;
    std::size_t								_size;
    bool									_isBinary;
...
{
public:
    explicit OutputParameter(Poco::SQL::MetaColumn::ColumnDataType aFieldType,
    ...
    void setValues(Poco::SQL::MetaColumn::ColumnDataType	aFieldType,
				   Oid										anInternalFieldType,
				   std::size_t								aRowNumber,
				   const char*								aDataPtr,
				   std::size_t								theSize,
...
inline
InputParameter::InputParameter(Poco::SQL::MetaColumn::ColumnDataType	aFieldType,
							   const void*								aDataPtr,
							   std::size_t								theSize)
...
inline
Poco::SQL::MetaColumn::ColumnDataType
...
// OutputParameter
inline
OutputParameter::OutputParameter(Poco::SQL::MetaColumn::ColumnDataType	aFieldType,
                                  Oid									anInternalFieldType,
                                  std::size_t							aRowNumber,
                                  const char*							aDataPtr,
                                  std::size_t							theSize,
...
inline
void
OutputParameter::setValues(Poco::SQL::MetaColumn::ColumnDataType	aFieldType,
						   Oid										anInternalFieldType,
						   std::size_t								aRowNumber,
						   const char*								aDataPtr,
						   std::size_t								theSize,
