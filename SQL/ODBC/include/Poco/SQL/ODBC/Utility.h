...
#ifndef SQL_ODBC_Utility_INCLUDED
#define SQL_ODBC_Utility_INCLUDED
...
public:
	...
	static void dateSync(SQL_DATE_STRUCT& ts, const Date& dt);
		/// Transfers data from Poco::SQL::Date to ODBC SQL_DATE_STRUCT.

	template <typename C>
	static void dateSync(std::vector<SQL_DATE_STRUCT>& ds, const C& d)
		/// Transfers data from Poco::SQL::Date vector to ODBC SQL_DATE_STRUCT container.
	{
	...
	static void timeSync(SQL_TIME_STRUCT& ts, const Time& dt);
		/// Transfers data from Poco::SQL::Time to ODBC SQL_TIME_STRUCT.

	template <typename C>
	static void timeSync(std::vector<SQL_TIME_STRUCT>& ts, const C& t)
		/// Transfers data from Poco::SQL::Time container to ODBC SQL_TIME_STRUCT vector.
	{
