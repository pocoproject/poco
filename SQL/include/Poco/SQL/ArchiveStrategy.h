...
#ifndef SQL_ArchiveStrategy_INCLUDED
#define SQL_ArchiveStrategy_INCLUDED
...
class Poco_SQL_API ArchiveStrategy
...
//
class Poco_SQL_API ArchiveByAgeStrategy: public ArchiveStrategy
