...
using Poco::SQL::SessionPoolContainer;
using Poco::SQL::SessionPoolExhaustedException;
using Poco::SQL::SessionPoolExistsException;
using Poco::SQL::SessionUnavailableException;
...
void SessionPoolTest::testSessionPoolContainer()
{
	...
	Poco::SQL::Session sess = spc.get("test:///cs");
