...
#ifndef SQL_SQLite_SessionImpl_INCLUDED
#define SQL_SQLite_SessionImpl_INCLUDED
...
class SQLite_API SessionImpl: public Poco::SQL::AbstractSessionImpl<SessionImpl>
