	...
	/// from the beginning of the given string, if it's there.
{
	...
	[[nodiscard]] static int icompare(const std::string& str, std::string::size_type pos, std::string::size_type n, std::string::const_iterator it2, std::string::const_iterator end2);
	[[nodiscard]] static int icompare(const std::string& str1, const std::string& str2);
	[[nodiscard]] static int icompare(const std::string& str1, std::string::size_type n1, const std::string& str2, std::string::size_type n2);
	[[nodiscard]] static int icompare(const std::string& str1, std::string::size_type n, const std::string& str2);
	[[nodiscard]] static int icompare(const std::string& str1, std::string::size_type pos, std::string::size_type n, const std::string& str2);
	[[nodiscard]] static int icompare(const std::string& str1, std::string::size_type pos1, std::string::size_type n1, const std::string& str2, std::string::size_type pos2, std::string::size_type n2);
	[[nodiscard]] static int icompare(const std::string& str1, std::string::size_type pos1, std::string::size_type n, const std::string& str2, std::string::size_type pos2);
	[[nodiscard]] static int icompare(const std::string& str, std::string::size_type pos, std::string::size_type n, const std::string::value_type* ptr);
	[[nodiscard]] static int icompare(const std::string& str, std::string::size_type pos, const std::string::value_type* ptr);
	[[nodiscard]] static int icompare(const std::string& str, const std::string::value_type* ptr);
	...
	[[nodiscard]] static std::string unescape(const std::string::const_iterator& begin, const std::string::const_iterator& end);
		/// Creates an UTF8 string from a string that contains escaped characters.

	[[nodiscard]] static std::string normalize(const std::string& s, NormalizationForm form);
		/// Normalizes the given UTF8 string according to the given normalization form.
		/// Returns the normalized UTF8 string.

	[[nodiscard]] static std::string normalize(const std::string::const_iterator& begin, const std::string::const_iterator& end, NormalizationForm form);
