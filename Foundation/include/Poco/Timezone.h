...
public:
	...
	[[nodiscard]] static std::string standardName();
		/// Returns the timezone name if not daylight saving time is in effect.

	[[nodiscard]] static std::string dstName();
