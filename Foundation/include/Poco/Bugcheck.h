...
{
public:
	[[noreturn]] static void assertion(const char* cond, const char* file, int line, const char* text = nullptr);
...
protected:
	static std::string what(const char* msg, const char* file, int line, const char* text = nullptr);
};
