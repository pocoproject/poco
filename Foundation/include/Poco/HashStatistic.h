...
public:
	...
	[[nodiscard]] double avgEntriesPerHashExclZeroEntries() const;
	...
	[[nodiscard]] UInt32 maxEntriesPerHash() const;
		/// Returns the maximum number of entries per hash value found in the current table.

	[[nodiscard]] const std::vector<UInt32> detailedEntriesPerHash() const;
