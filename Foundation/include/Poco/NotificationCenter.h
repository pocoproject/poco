...
#pragma GCC diagnostic pop
	...
	[[nodiscard]] bool hasObserver(const AbstractObserver& observer) const;
	...
	[[nodiscard]] static NotificationCenter& defaultCenter();
...
protected:
	...
	[[nodiscard]] RWLock& mutex()
	{
		return _mutex;
	}

	[[nodiscard]] ObserverList observersToNotify(const Notification::Ptr& pNotification) const;
