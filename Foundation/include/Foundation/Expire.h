...
// Expire.h
//
// $Id: //poco/1.1.0/Foundation/include/Foundation/Expire.h#2 $
//
// Library: Foundation
// Package: Events
// Module:  Expire
...
{
public:
	Expire(const AbstractDelegate<TArgs>& p, Foundation::Timestamp::TimeDiff expireMillisecs):
		_pDelegate(p.clone()), 
...
protected:
	Expire(AbstractDelegate<TArgs>* p, Foundation::Timestamp::TimeDiff expireMillisecs):
		_pDelegate(p), 
		_expire(expireMillisecs*1000)
	{
	}
