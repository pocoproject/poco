...
// SignalHandler.h
//
// $Id: //poco/1.1.0/Foundation/include/Foundation/SignalHandler.h#2 $
//
// Library: Foundation
// Package: Threading
...
#endif
#ifndef STD_SETJMP_H_INCLUDED
#include <setjmp.h>
#define STD_SETJMP_H_INCLUDED
#endif
...
class Foundation_API SignalHandler
	...
	///          ...
	///     }
	///     catch (Foundation::SignalException&)
	///     {
	///         ...
	///     }
	///
...
#define poco_throw_on_signal \
	Foundation::SignalHandler _poco_signalHandler; \
