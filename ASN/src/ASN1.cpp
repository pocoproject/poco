...
// ASN1.cpp
//
// $Id: //poco/1.4/ASN/src/ASN1.cpp#1 $
//
// Library: ASN
// Package: ASN
// Module:  ASN1
...
void ASN1::dump(std::ostream &stream, int indent) const
{
	stream << Whitespace(indent) << "ASN.1 0x" << Poco::NumberFormatter::formatHex(_type.rawValue()) << " " << getDataLength() << " BYTES" << std::endl;
}
