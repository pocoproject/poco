...
public:
	...
	[[nodiscard]] bool hasFeature(const XMLString& feature, const XMLString& version) const;
	...
	// DOM Level 2
	[[nodiscard]] DocumentType* createDocumentType(const XMLString& name, const XMLString& publicId, const XMLString& systemId) const;
	...
	[[nodiscard]] Document* createDocument(const XMLString& namespaceURI, const XMLString& qualifiedName, DocumentType* doctype) const;
		/// Creates an XML Document object of the specified type with its document element.
		///
		/// Note: You can also create a Document directly using the new operator.

	[[nodiscard]] static const DOMImplementation& instance();
