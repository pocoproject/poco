...
public:
	...
	[[nodiscard]] virtual const XMLString& nodeName() const = 0;
		/// Returns the name of this node, depending on its type.

	[[nodiscard]] const XMLString& nodeValue() const;
		/// Returns the value of this node, depending on its type.

	[[nodiscard]] virtual const XMLString& getNodeValue() const = 0;
		/// Returns the value of this node, depending on its type.
	...
	[[nodiscard]] virtual unsigned short nodeType() const = 0;
		/// Returns a code representing the type of the underlying object.

	[[nodiscard]] virtual Node* parentNode() const = 0;
	...
	[[nodiscard]] virtual NodeList* childNodes() const = 0;
	...
	[[nodiscard]] virtual Document* ownerDocument() const = 0;
	...
	[[nodiscard]] virtual bool hasChildNodes() const = 0;
		/// This is a convenience method to allow easy determination of whether a
		/// node has any children.
		/// Returns true if the node has any children, false otherwise.

	[[nodiscard]] virtual Node* cloneNode(bool deep) const = 0;
	...
	[[nodiscard]] virtual bool isSupported(const XMLString& feature, const XMLString& version) const = 0;
		/// Tests whether the DOM implementation implements a specific
		/// feature and that feature is supported by this node.

	[[nodiscard]] virtual const XMLString& namespaceURI() const = 0;
	...
	[[nodiscard]] virtual XMLString prefix() const = 0;
		/// Returns the namespace prefix from the qualified name of the node.

	[[nodiscard]] virtual const XMLString& localName() const = 0;
		/// Returns the local name of the node.

	[[nodiscard]] virtual bool hasAttributes() const = 0;
		/// Returns whether this node (if it is an element) has any attributes.

	// Extensions
	using NSMap = Poco::XML::NamespaceSupport;

	[[nodiscard]] virtual XMLString innerText() const = 0;
	...
	[[nodiscard]] virtual Node* getNodeByPath(const XMLString& path) const = 0;
	...
	[[nodiscard]] virtual Node* getNodeByPathNS(const XMLString& path, const NSMap& nsMap) const = 0;
		/// Searches a node (element or attribute) based on a simplified XPath
