...
{
public:
	[[nodiscard]] virtual Node* getNamedItem(const XMLString& name) const = 0;
	...
	// DOM Level 2
	[[nodiscard]] virtual Node* getNamedItemNS(const XMLString& namespaceURI, const XMLString& localName) const = 0;
		/// Retrieves a node specified by name.
