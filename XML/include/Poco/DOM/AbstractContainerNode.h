...
{
public:
	typedef Poco::AutoPtr<AbstractContainerNode> Ptr;
...
protected:
	AbstractContainerNode(AutoPtr<Document> pOwnerDocument);
	...
	static const AutoPtr<Attr> findAttribute(const XMLString& name, Node::Ptr pNode, const Node::NSMap* pNSMap);
