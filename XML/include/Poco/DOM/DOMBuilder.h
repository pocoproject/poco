...
{
public:
	typedef AutoPtr<DOMBuilder> Ptr;

	DOMBuilder(AutoPtr<XMLReader> xmlReader, AutoPtr<NamePool> pNamePool = 0);
	...
	virtual Document::Ptr parse(AutoPtr<InputSource> pInputSource);
