...
public:
	...
	RefPtr<NamedNodeMap> notations() const;
...
protected:
	DocumentType(RefPtr<Document> pOwner, const XMLString& name, const XMLString& publicId, const XMLString& systemId);
	DocumentType(RefPtr<Document> pOwner, const DocumentType& dt);
	~DocumentType();
