...
public:
	...
	[[nodiscard]] Node* setNamedItem(Node* arg);
	...
	[[nodiscard]] Node* setNamedItemNS(Node* arg);
	[[nodiscard]] Node* removeNamedItemNS(const XMLString& namespaceURI, const XMLString& localName);
