...
public:
	...
	[[nodiscard]] NamePool& namePool();
		/// Returns a pointer to the documents Name Pool.

	[[nodiscard]] AutoReleasePool& autoReleasePool();
	...
	[[nodiscard]] const DOMImplementation& implementation() const;
	...
	[[nodiscard]] Element* createElement(const XMLString& tagName) const;
	...
	[[nodiscard]] DocumentFragment* createDocumentFragment() const;
		/// Creates an empty DocumentFragment object.

	[[nodiscard]] Text* createTextNode(const XMLString& data) const;
		/// Creates a text node given the specified string.

	[[nodiscard]] Comment* createComment(const XMLString& data) const;
		/// Creates a comment node given the specified string.

	[[nodiscard]] CDATASection* createCDATASection(const XMLString& data) const;
		/// Creates a CDATASection node whose value is the specified string.

	[[nodiscard]] ProcessingInstruction* createProcessingInstruction(const XMLString& target, const XMLString& data) const;
		/// Creates a ProcessingInstruction node given the specified target and data strings.

	[[nodiscard]] Attr* createAttribute(const XMLString& name) const;
	...
	[[nodiscard]] EntityReference* createEntityReference(const XMLString& name) const;
	...
	[[nodiscard]] Element* createElementNS(const XMLString& namespaceURI, const XMLString& qualifiedName) const;
		/// Creates an element of the given qualified name and namespace URI.

	[[nodiscard]] Attr* createAttributeNS(const XMLString& namespaceURI, const XMLString& qualifiedName) const;
	...
	[[nodiscard]] Element* getElementById(const XMLString& elementId) const;
	...
	// DocumentEvent
	[[nodiscard]] Event* createEvent(const XMLString& eventType) const;
	...
	// Extensions
	[[nodiscard]] Entity* createEntity(const XMLString& name, const XMLString& publicId, const XMLString& systemId, const XMLString& notationName) const;
	...
	[[nodiscard]] Notation* createNotation(const XMLString& name, const XMLString& publicId, const XMLString& systemId) const;
...
protected:
	...
	[[nodiscard]] DocumentType* getDoctype();
