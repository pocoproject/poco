...
class XML_API XMLReader: virtual public RefCountedObject
...
{
public:
	typedef AutoPtr<XMLReader> Ptr;

	virtual void setEntityResolver(AutoPtr<EntityResolver> pResolver) = 0;
	...
	virtual void setDTDHandler(AutoPtr<DTDHandler> pDTDHandler) = 0;
	...
	virtual void setContentHandler(AutoPtr<ContentHandler> pContentHandler) = 0;
	...
	virtual void setErrorHandler(AutoPtr<ErrorHandler> pErrorHandler) = 0;
	...
	virtual void setProperty(const XMLString& propertyId, AutoPtr<SAXHandler> value) = 0;
		/// Set the value of a property.
		/// See also setProperty(const XMLString&, const XMLString&).

	virtual AutoPtr<SAXHandler> getProperty(const XMLString& propertyId) const = 0;
	...
	virtual void parse(AutoPtr<InputSource> pSource) = 0;
