...
class XML_API EntityResolver: virtual public Poco::XML::WeakRefCountedObject
...
{
public:
	typedef RefPtr<EntityResolver> Ptr;

	virtual RefPtr<InputSource> resolveEntity(const XMLString* publicId, const XMLString& systemId) = 0;
