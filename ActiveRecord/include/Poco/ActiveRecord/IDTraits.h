...
public:
	...
	[[nodiscard]] static bool isValid(Poco::UInt64 id)
	{
		return id != INVALID_ID;
	}

	[[nodiscard]] static std::string toString(Poco::UInt64 id)
	{
...
public:
	...
	[[nodiscard]] static bool isValid(Poco::Int64 id)
	{
		return id != INVALID_ID;
	}

	[[nodiscard]] static std::string toString(Poco::Int64 id)
	{
		return Poco::NumberFormatter::format(id);
	}
};
...
public:
	...
	[[nodiscard]] static bool isValid(Poco::UInt32 id)
	{
		return id != INVALID_ID;
	}

	[[nodiscard]] static std::string toString(Poco::UInt32 id)
	{
		return Poco::NumberFormatter::format(id);
	}
};
...
public:
	...
	[[nodiscard]] static bool isValid(Poco::Int32 id)
	{
		return id != INVALID_ID;
	}

	[[nodiscard]] static std::string toString(Poco::Int32 id)
	{
		return Poco::NumberFormatter::format(id);
	}
};
...
public:
	...
	[[nodiscard]] static bool isValid(Poco::UInt16 id)
	{
		return id != INVALID_ID;
	}

	[[nodiscard]] static std::string toString(Poco::UInt16 id)
	{
		return Poco::NumberFormatter::format(id);
	}
};
...
public:
	...
	[[nodiscard]] static bool isValid(Poco::Int16 id)
	{
		return id != INVALID_ID;
	}

	[[nodiscard]] static std::string toString(Poco::Int16 id)
	{
		return Poco::NumberFormatter::format(id);
	}
};
...
public:
	...
	[[nodiscard]] static bool isValid(const std::string& id)
	{
		return !id.empty();
	}

	[[nodiscard]] static std::string toString(const std::string& id)
	{
		return id;
	}
};
...
public:
	...
	[[nodiscard]] static bool isValid(const Poco::UUID& id)
	{
		return !id.isNull();
	}

	[[nodiscard]] static std::string toString(const Poco::UUID& id)
	{
		return id.toString();
	}
};
