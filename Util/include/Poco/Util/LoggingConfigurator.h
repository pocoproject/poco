...
private:
	...
	[[nodiscard]] Poco::Formatter::Ptr createFormatter(AbstractConfiguration::Ptr pConfig);
	[[nodiscard]] Poco::Channel::Ptr createChannel(AbstractConfiguration::Ptr pConfig);
