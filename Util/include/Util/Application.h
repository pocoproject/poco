...
// Application.h
//
// $Id: //poco/1.1.0/Util/include/Util/Application.h#2 $
//
// Library: Util
// Package: Application
// Module:  Application
...
public:
	...
	const Foundation::Timestamp& startTime() const;
		/// Returns the application start time (UTC).

	Foundation::Timespan uptime() const;
...
protected:
	...
	void setLogger(Foundation::Logger& logger);
	...
	bool findFile(Foundation::Path& path) const;
...
private:
	...
	void getApplicationPath(Foundation::Path& path) const;
	void processOptions();
	bool findAppConfigFile(const std::string& appName, const std::string& extension, Foundation::Path& path) const;
	...
	OptionSet             _options;
	bool                  _unixOptions;
	Foundation::Logger*   _pLogger;
	Foundation::Timestamp _startTime;
...
inline const Foundation::Timestamp& Application::startTime() const
{
	return _startTime;
}


inline Foundation::Timespan Application::uptime() const
{
	Foundation::Timestamp now;
	Foundation::Timespan uptime = now - _startTime;
