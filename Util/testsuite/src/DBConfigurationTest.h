...
#ifndef DBConfigurationTest_INCLUDED
#define DBConfigurationTest_INCLUDED
...
class DBConfigurationTest: public AbstractConfigurationTest
{
public:
	DBConfigurationTest(const std::string& name);
	virtual ~DBConfigurationTest();
