...
{
public:
	[[nodiscard]] static Context::VerificationMode convertVerificationMode(const std::string& verMode);
	...
	[[nodiscard]] static std::string convertCertificateError(long errCode);
