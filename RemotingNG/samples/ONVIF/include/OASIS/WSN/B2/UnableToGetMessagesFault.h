...
#ifndef OASIS_WSN_B2_UnableToGetMessagesFault_INCLUDED
#define OASIS_WSN_B2_UnableToGetMessagesFault_INCLUDED
...
//@ serialize
class ONVIF_API UnableToGetMessagesFault: public OASIS::WSRF::BF2::BaseFault
{
public:
	...
	virtual ~UnableToGetMessagesFault();
...
#endif // OASIS_WSN_B2_UnableToGetMessagesFault_INCLUDED
