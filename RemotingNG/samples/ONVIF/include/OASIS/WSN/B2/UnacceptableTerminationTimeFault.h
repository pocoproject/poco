// 
// UnacceptableTerminationTimeFault.h
// 
...
#ifndef OASIS_WSN_B2_UnacceptableTerminationTimeFault_INCLUDED
#define OASIS_WSN_B2_UnacceptableTerminationTimeFault_INCLUDED
...
//@ serialize
class ONVIF_API UnacceptableTerminationTimeFault: public OASIS::WSRF::BF2::BaseFault
{
public:
	...
	virtual ~UnacceptableTerminationTimeFault();
...
inline const Poco::Optional<Poco::DateTime>& UnacceptableTerminationTimeFault::getMaximumTime() const
{
	return _maximumTime;
}


inline const Poco::DateTime& UnacceptableTerminationTimeFault::getMinimumTime() const
{
	return _minimumTime;
}


inline void UnacceptableTerminationTimeFault::setMaximumTime(const Poco::Optional<Poco::DateTime>& val)
{
	_maximumTime = val;
}


inline void UnacceptableTerminationTimeFault::setMaximumTime(Poco::Optional<Poco::DateTime>&& val)
{
	_maximumTime = std::move(val);
}


inline void UnacceptableTerminationTimeFault::setMinimumTime(const Poco::DateTime& val)
{
	_minimumTime = val;
}


inline void UnacceptableTerminationTimeFault::setMinimumTime(Poco::DateTime&& val)
{
...
#endif // OASIS_WSN_B2_UnacceptableTerminationTimeFault_INCLUDED
