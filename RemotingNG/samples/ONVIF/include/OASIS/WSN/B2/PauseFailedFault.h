...
#ifndef OASIS_WSN_B2_PauseFailedFault_INCLUDED
#define OASIS_WSN_B2_PauseFailedFault_INCLUDED
...
//@ serialize
class ONVIF_API PauseFailedFault: public OASIS::WSRF::BF2::BaseFault
{
public:
	PauseFailedFault();
...
#endif // OASIS_WSN_B2_PauseFailedFault_INCLUDED
