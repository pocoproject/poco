...
#ifndef ONVIF_Media_GetAudioSourceConfigurationOptions_INCLUDED
#define ONVIF_Media_GetAudioSourceConfigurationOptions_INCLUDED
...
inline const Poco::Optional<std::string>& GetAudioSourceConfigurationOptions::getConfigurationToken() const
{
	return _configurationToken;
}


inline const Poco::Optional<std::string>& GetAudioSourceConfigurationOptions::getProfileToken() const
{
	return _profileToken;
}


inline void GetAudioSourceConfigurationOptions::setConfigurationToken(const Poco::Optional<std::string>& val)
{
	_configurationToken = val;
}


inline void GetAudioSourceConfigurationOptions::setConfigurationToken(Poco::Optional<std::string>&& val)
{
	_configurationToken = std::move(val);
}


inline void GetAudioSourceConfigurationOptions::setProfileToken(const Poco::Optional<std::string>& val)
{
	_profileToken = val;
}


inline void GetAudioSourceConfigurationOptions::setProfileToken(Poco::Optional<std::string>&& val)
{
...
#endif // ONVIF_Media_GetAudioSourceConfigurationOptions_INCLUDED
