...
#ifndef TypeDeserializer_ONVIF_Vector_INCLUDED
#define TypeDeserializer_ONVIF_Vector_INCLUDED
...
template <>
class TypeDeserializer<ONVIF::Vector>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, ONVIF::Vector& value)
	{
	...
	static void deserializeAttributes(Deserializer& deser, ONVIF::Vector& value)
	{
		using namespace std::string_literals;
	...
	static void deserializeImpl(Deserializer& deser, ONVIF::Vector& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_ONVIF_Vector_INCLUDED
