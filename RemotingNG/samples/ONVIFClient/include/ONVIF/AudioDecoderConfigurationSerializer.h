//
// AudioDecoderConfigurationSerializer.h
//
// Package: Generated
...
#ifndef TypeSerializer_ONVIF_AudioDecoderConfiguration_INCLUDED
#define TypeSerializer_ONVIF_AudioDecoderConfiguration_INCLUDED
...
template <>
class TypeSerializer<ONVIF::AudioDecoderConfiguration>
{
public:
	...
	static void serialize(const std::string& name, const ONVIF::AudioDecoderConfiguration& value, Serializer& ser)
	{
		using namespace std::string_literals;
	...
	static void serializeAttributes(const ONVIF::AudioDecoderConfiguration& value, Serializer& ser)
	{
		// ONVIF::ConfigurationEntity
		{
		using namespace std::string_literals;
	...
	static void serializeImpl(const ONVIF::AudioDecoderConfiguration& value, Serializer& ser)
	{
		using namespace std::string_literals;
...
#endif // TypeSerializer_ONVIF_AudioDecoderConfiguration_INCLUDED
