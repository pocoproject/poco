...
#ifndef TypeDeserializer_ONVIF_AACDecOptions_INCLUDED
#define TypeDeserializer_ONVIF_AACDecOptions_INCLUDED
...
template <>
class TypeDeserializer<ONVIF::AACDecOptions>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, ONVIF::AACDecOptions& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, ONVIF::AACDecOptions& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_ONVIF_AACDecOptions_INCLUDED
