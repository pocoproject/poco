//
// VideoOutputConfigurationSerializer.h
//
// Package: Generated
...
#ifndef TypeSerializer_ONVIF_VideoOutputConfiguration_INCLUDED
#define TypeSerializer_ONVIF_VideoOutputConfiguration_INCLUDED
...
template <>
class TypeSerializer<ONVIF::VideoOutputConfiguration>
{
public:
	...
	static void serialize(const std::string& name, const ONVIF::VideoOutputConfiguration& value, Serializer& ser)
	{
		using namespace std::string_literals;
	...
	static void serializeAttributes(const ONVIF::VideoOutputConfiguration& value, Serializer& ser)
	{
		// ONVIF::ConfigurationEntity
		{
		using namespace std::string_literals;
	...
	static void serializeImpl(const ONVIF::VideoOutputConfiguration& value, Serializer& ser)
	{
		using namespace std::string_literals;
		...
		static const std::string REMOTING__NAMES[] = {"OutputToken"s,""s};
		TypeSerializer<std::string>::serialize(REMOTING__NAMES[0], value.getOutputToken(), ser);
	}
...
#endif // TypeSerializer_ONVIF_VideoOutputConfiguration_INCLUDED
