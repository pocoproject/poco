//
// AudioSourceConfigurationDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_ONVIF_AudioSourceConfiguration_INCLUDED
#define TypeDeserializer_ONVIF_AudioSourceConfiguration_INCLUDED
...
template <>
class TypeDeserializer<ONVIF::AudioSourceConfiguration>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, ONVIF::AudioSourceConfiguration& value)
	{
	...
	static void deserializeAttributes(Deserializer& deser, ONVIF::AudioSourceConfiguration& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, ONVIF::AudioSourceConfiguration& value)
	{
		using namespace std::string_literals;
		...
		static const std::string REMOTING__NAMES[] = {"SourceToken"s};
		bool ret = false;
...
#endif // TypeDeserializer_ONVIF_AudioSourceConfiguration_INCLUDED
