//
// AudioSourceConfigurationSerializer.h
//
// Package: Generated
...
#ifndef TypeSerializer_ONVIF_AudioSourceConfiguration_INCLUDED
#define TypeSerializer_ONVIF_AudioSourceConfiguration_INCLUDED
...
template <>
class TypeSerializer<ONVIF::AudioSourceConfiguration>
{
public:
	...
	static void serialize(const std::string& name, const ONVIF::AudioSourceConfiguration& value, Serializer& ser)
	{
		using namespace std::string_literals;
	...
	static void serializeAttributes(const ONVIF::AudioSourceConfiguration& value, Serializer& ser)
	{
		// ONVIF::ConfigurationEntity
		{
		using namespace std::string_literals;
	...
	static void serializeImpl(const ONVIF::AudioSourceConfiguration& value, Serializer& ser)
	{
		using namespace std::string_literals;
		...
		static const std::string REMOTING__NAMES[] = {"SourceToken"s,""s};
...
#endif // TypeSerializer_ONVIF_AudioSourceConfiguration_INCLUDED
