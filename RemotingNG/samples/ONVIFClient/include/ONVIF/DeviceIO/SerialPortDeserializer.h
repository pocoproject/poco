...
#ifndef TypeDeserializer_ONVIF_DeviceIO_SerialPort_INCLUDED
#define TypeDeserializer_ONVIF_DeviceIO_SerialPort_INCLUDED
...
template <>
class TypeDeserializer<ONVIF::DeviceIO::SerialPort>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, ONVIF::DeviceIO::SerialPort& value)
	{
	...
	static void deserializeAttributes(Deserializer& deser, ONVIF::DeviceIO::SerialPort& value)
	{
		// ONVIF::DeviceEntity
		{
		using namespace std::string_literals;
	...
	static void deserializeImpl(Deserializer& deser, ONVIF::DeviceIO::SerialPort& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_ONVIF_DeviceIO_SerialPort_INCLUDED
