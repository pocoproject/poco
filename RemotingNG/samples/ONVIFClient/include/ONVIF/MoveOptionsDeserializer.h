...
#ifndef TypeDeserializer_ONVIF_MoveOptions_INCLUDED
#define TypeDeserializer_ONVIF_MoveOptions_INCLUDED
...
#include "ONVIF/RelativeFocusOptionsDeserializer.h"
#include "ONVIF/RelativeFocusOptionsSerializer.h"
...
template <>
class TypeDeserializer<ONVIF::MoveOptions>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, ONVIF::MoveOptions& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, ONVIF::MoveOptions& value)
	{
		using namespace std::string_literals;
		...
		Poco::SharedPtr<ONVIF::RelativeFocusOptions> gen_relative;
		ret = TypeDeserializer<Poco::SharedPtr<ONVIF::RelativeFocusOptions>>::deserialize(REMOTING__NAMES[1], false, deser, gen_relative);
...
#endif // TypeDeserializer_ONVIF_MoveOptions_INCLUDED
