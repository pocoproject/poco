//
// AudioEncoderConfigurationOptionDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_ONVIF_AudioEncoderConfigurationOption_INCLUDED
#define TypeDeserializer_ONVIF_AudioEncoderConfigurationOption_INCLUDED
...
template <>
class TypeDeserializer<ONVIF::AudioEncoderConfigurationOption>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, ONVIF::AudioEncoderConfigurationOption& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, ONVIF::AudioEncoderConfigurationOption& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_ONVIF_AudioEncoderConfigurationOption_INCLUDED
