...
#ifndef TypeSerializer_ONVIF_PTZVector_INCLUDED
#define TypeSerializer_ONVIF_PTZVector_INCLUDED
...
template <>
class TypeSerializer<ONVIF::PTZVector>
{
public:
	static void serialize(const std::string& name, const ONVIF::PTZVector& value, Serializer& ser)
	{
	...
	static void serializeImpl(const ONVIF::PTZVector& value, Serializer& ser)
	{
		using namespace std::string_literals;
...
#endif // TypeSerializer_ONVIF_PTZVector_INCLUDED
