//
// AnalyticsEngineInputSerializer.h
//
// Package: Generated
...
#ifndef TypeSerializer_ONVIF_AnalyticsEngineInput_INCLUDED
#define TypeSerializer_ONVIF_AnalyticsEngineInput_INCLUDED
...
template <>
class TypeSerializer<ONVIF::AnalyticsEngineInput>
{
public:
	...
	static void serialize(const std::string& name, const ONVIF::AnalyticsEngineInput& value, Serializer& ser)
	{
		using namespace std::string_literals;
	...
	static void serializeAttributes(const ONVIF::AnalyticsEngineInput& value, Serializer& ser)
	{
		// ONVIF::ConfigurationEntity
		{
		using namespace std::string_literals;
	...
	static void serializeImpl(const ONVIF::AnalyticsEngineInput& value, Serializer& ser)
	{
		using namespace std::string_literals;
		...
		static const std::string REMOTING__NAMES[] = {"SourceIdentification"s,"VideoInput"s,"MetadataInput"s,""s};
		TypeSerializer<ONVIF::SourceIdentification>::serialize(REMOTING__NAMES[0], value.getSourceIdentification(), ser);
		TypeSerializer<ONVIF::VideoEncoderConfiguration>::serialize(REMOTING__NAMES[1], value.getVideoInput(), ser);
		TypeSerializer<ONVIF::MetadataInput>::serialize(REMOTING__NAMES[2], value.getMetadataInput(), ser);
	}
...
#endif // TypeSerializer_ONVIF_AnalyticsEngineInput_INCLUDED
