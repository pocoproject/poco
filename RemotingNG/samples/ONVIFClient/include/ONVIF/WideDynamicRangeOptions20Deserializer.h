//
// WideDynamicRangeOptions20Deserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_ONVIF_WideDynamicRangeOptions20_INCLUDED
#define TypeDeserializer_ONVIF_WideDynamicRangeOptions20_INCLUDED
...
template <>
class TypeDeserializer<ONVIF::WideDynamicRangeOptions20>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, ONVIF::WideDynamicRangeOptions20& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, ONVIF::WideDynamicRangeOptions20& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_ONVIF_WideDynamicRangeOptions20_INCLUDED
