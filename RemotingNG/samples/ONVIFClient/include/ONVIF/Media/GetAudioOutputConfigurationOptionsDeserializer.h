...
#ifndef TypeDeserializer_ONVIF_Media_GetAudioOutputConfigurationOptions_INCLUDED
#define TypeDeserializer_ONVIF_Media_GetAudioOutputConfigurationOptions_INCLUDED
...
template <>
class TypeDeserializer<ONVIF::Media::GetAudioOutputConfigurationOptions>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, ONVIF::Media::GetAudioOutputConfigurationOptions& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, ONVIF::Media::GetAudioOutputConfigurationOptions& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_ONVIF_Media_GetAudioOutputConfigurationOptions_INCLUDED
