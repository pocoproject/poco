//
// SetAudioEncoderConfigurationDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_ONVIF_Media_SetAudioEncoderConfiguration_INCLUDED
#define TypeDeserializer_ONVIF_Media_SetAudioEncoderConfiguration_INCLUDED
...
template <>
class TypeDeserializer<ONVIF::Media::SetAudioEncoderConfiguration>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, ONVIF::Media::SetAudioEncoderConfiguration& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, ONVIF::Media::SetAudioEncoderConfiguration& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_ONVIF_Media_SetAudioEncoderConfiguration_INCLUDED
