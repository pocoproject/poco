...
#ifndef TypeDeserializer_ONVIF_NetworkGateway_INCLUDED
#define TypeDeserializer_ONVIF_NetworkGateway_INCLUDED
...
template <>
class TypeDeserializer<ONVIF::NetworkGateway>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, ONVIF::NetworkGateway& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, ONVIF::NetworkGateway& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_ONVIF_NetworkGateway_INCLUDED
