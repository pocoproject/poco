...
#ifndef TypeDeserializer_ONVIF_PTZVector_INCLUDED
#define TypeDeserializer_ONVIF_PTZVector_INCLUDED
...
template <>
class TypeDeserializer<ONVIF::PTZVector>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, ONVIF::PTZVector& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, ONVIF::PTZVector& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_ONVIF_PTZVector_INCLUDED
