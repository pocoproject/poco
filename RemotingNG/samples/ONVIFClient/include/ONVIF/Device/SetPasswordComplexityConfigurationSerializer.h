//
// SetPasswordComplexityConfigurationSerializer.h
//
// Package: Generated
...
#ifndef TypeSerializer_ONVIF_Device_SetPasswordComplexityConfiguration_INCLUDED
#define TypeSerializer_ONVIF_Device_SetPasswordComplexityConfiguration_INCLUDED
...
template <>
class TypeSerializer<ONVIF::Device::SetPasswordComplexityConfiguration>
{
public:
	static void serialize(const std::string& name, const ONVIF::Device::SetPasswordComplexityConfiguration& value, Serializer& ser)
	{
	...
	static void serializeImpl(const ONVIF::Device::SetPasswordComplexityConfiguration& value, Serializer& ser)
	{
		using namespace std::string_literals;
...
#endif // TypeSerializer_ONVIF_Device_SetPasswordComplexityConfiguration_INCLUDED
