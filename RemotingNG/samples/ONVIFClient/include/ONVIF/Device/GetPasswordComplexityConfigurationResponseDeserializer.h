//
// GetPasswordComplexityConfigurationResponseDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_ONVIF_Device_GetPasswordComplexityConfigurationResponse_INCLUDED
#define TypeDeserializer_ONVIF_Device_GetPasswordComplexityConfigurationResponse_INCLUDED
...
template <>
class TypeDeserializer<ONVIF::Device::GetPasswordComplexityConfigurationResponse>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, ONVIF::Device::GetPasswordComplexityConfigurationResponse& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, ONVIF::Device::GetPasswordComplexityConfigurationResponse& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_ONVIF_Device_GetPasswordComplexityConfigurationResponse_INCLUDED
