...
#ifndef TypeDeserializer_ONVIF_G726DecOptions_INCLUDED
#define TypeDeserializer_ONVIF_G726DecOptions_INCLUDED
...
template <>
class TypeDeserializer<ONVIF::G726DecOptions>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, ONVIF::G726DecOptions& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, ONVIF::G726DecOptions& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_ONVIF_G726DecOptions_INCLUDED
