...
#ifndef TypeDeserializer_ONVIF_AnalyticsEngine_INCLUDED
#define TypeDeserializer_ONVIF_AnalyticsEngine_INCLUDED
...
template <>
class TypeDeserializer<ONVIF::AnalyticsEngine>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, ONVIF::AnalyticsEngine& value)
	{
	...
	static void deserializeAttributes(Deserializer& deser, ONVIF::AnalyticsEngine& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, ONVIF::AnalyticsEngine& value)
	{
		using namespace std::string_literals;
		...
		static const std::string REMOTING__NAMES[] = {"AnalyticsEngineConfiguration"s};
		bool ret = false;
		ONVIF::AnalyticsDeviceEngineConfiguration gen_analyticsEngineConfiguration;
		ret = TypeDeserializer<ONVIF::AnalyticsDeviceEngineConfiguration>::deserialize(REMOTING__NAMES[0], true, deser, gen_analyticsEngineConfiguration);
...
#endif // TypeDeserializer_ONVIF_AnalyticsEngine_INCLUDED
