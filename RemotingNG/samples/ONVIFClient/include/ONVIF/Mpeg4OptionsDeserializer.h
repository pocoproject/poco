...
#ifndef TypeDeserializer_ONVIF_Mpeg4Options_INCLUDED
#define TypeDeserializer_ONVIF_Mpeg4Options_INCLUDED
...
template <>
class TypeDeserializer<ONVIF::Mpeg4Options>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, ONVIF::Mpeg4Options& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, ONVIF::Mpeg4Options& value)
	{
		using namespace std::string_literals;
		
		static const std::string REMOTING__NAMES[] = {"ResolutionsAvailable"s,"GovLengthRange"s,"FrameRateRange"s,"EncodingIntervalRange"s,"Mpeg4ProfilesSupported"s};
		bool ret = false;
		...
		ret = TypeDeserializer<std::vector<std::string>>::deserialize(REMOTING__NAMES[4], true, deser, gen_mpeg4ProfilesSupported);
...
#endif // TypeDeserializer_ONVIF_Mpeg4Options_INCLUDED
