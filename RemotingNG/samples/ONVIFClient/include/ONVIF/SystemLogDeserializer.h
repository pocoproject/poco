...
#ifndef TypeDeserializer_ONVIF_SystemLog_INCLUDED
#define TypeDeserializer_ONVIF_SystemLog_INCLUDED
...
template <>
class TypeDeserializer<ONVIF::SystemLog>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, ONVIF::SystemLog& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, ONVIF::SystemLog& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_ONVIF_SystemLog_INCLUDED
