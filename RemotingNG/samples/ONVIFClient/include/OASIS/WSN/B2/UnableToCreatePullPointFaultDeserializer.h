//
// UnableToCreatePullPointFaultDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_OASIS_WSN_B2_UnableToCreatePullPointFault_INCLUDED
#define TypeDeserializer_OASIS_WSN_B2_UnableToCreatePullPointFault_INCLUDED
...
template <>
class TypeDeserializer<OASIS::WSN::B2::UnableToCreatePullPointFault>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, OASIS::WSN::B2::UnableToCreatePullPointFault& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, OASIS::WSN::B2::UnableToCreatePullPointFault& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_OASIS_WSN_B2_UnableToCreatePullPointFault_INCLUDED
