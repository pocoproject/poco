//
// InvalidMessageContentExpressionFaultDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_OASIS_WSN_B2_InvalidMessageContentExpressionFault_INCLUDED
#define TypeDeserializer_OASIS_WSN_B2_InvalidMessageContentExpressionFault_INCLUDED
...
template <>
class TypeDeserializer<OASIS::WSN::B2::InvalidMessageContentExpressionFault>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, OASIS::WSN::B2::InvalidMessageContentExpressionFault& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, OASIS::WSN::B2::InvalidMessageContentExpressionFault& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_OASIS_WSN_B2_InvalidMessageContentExpressionFault_INCLUDED
