...
#ifndef TypeSerializer_OASIS_WSN_B2_PauseFailedFault_INCLUDED
#define TypeSerializer_OASIS_WSN_B2_PauseFailedFault_INCLUDED
...
template <>
class TypeSerializer<OASIS::WSN::B2::PauseFailedFault>
{
public:
	static void serialize(const std::string& name, const OASIS::WSN::B2::PauseFailedFault& value, Serializer& ser)
	{
	...
	static void serializeImpl(const OASIS::WSN::B2::PauseFailedFault& value, Serializer& ser)
	{
		using namespace std::string_literals;
...
#endif // TypeSerializer_OASIS_WSN_B2_PauseFailedFault_INCLUDED
