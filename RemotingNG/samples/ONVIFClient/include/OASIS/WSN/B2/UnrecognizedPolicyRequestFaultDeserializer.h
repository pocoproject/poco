//
// UnrecognizedPolicyRequestFaultDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_OASIS_WSN_B2_UnrecognizedPolicyRequestFault_INCLUDED
#define TypeDeserializer_OASIS_WSN_B2_UnrecognizedPolicyRequestFault_INCLUDED
...
template <>
class TypeDeserializer<OASIS::WSN::B2::UnrecognizedPolicyRequestFault>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, OASIS::WSN::B2::UnrecognizedPolicyRequestFault& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, OASIS::WSN::B2::UnrecognizedPolicyRequestFault& value)
	{
		using namespace std::string_literals;
		...
		static const std::string REMOTING__NAMES[] = {"UnrecognizedPolicy"s};
		bool ret = false;
		std::vector<std::string> gen_unrecognizedPolicy;
		ret = TypeDeserializer<std::vector<std::string>>::deserialize(REMOTING__NAMES[0], false, deser, gen_unrecognizedPolicy);
		if (ret) value.setUnrecognizedPolicy(gen_unrecognizedPolicy);
	}
...
#endif // TypeDeserializer_OASIS_WSN_B2_UnrecognizedPolicyRequestFault_INCLUDED
