//
// UnableToDestroySubscriptionFaultDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_OASIS_WSN_B2_UnableToDestroySubscriptionFault_INCLUDED
#define TypeDeserializer_OASIS_WSN_B2_UnableToDestroySubscriptionFault_INCLUDED
...
template <>
class TypeDeserializer<OASIS::WSN::B2::UnableToDestroySubscriptionFault>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, OASIS::WSN::B2::UnableToDestroySubscriptionFault& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, OASIS::WSN::B2::UnableToDestroySubscriptionFault& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_OASIS_WSN_B2_UnableToDestroySubscriptionFault_INCLUDED
