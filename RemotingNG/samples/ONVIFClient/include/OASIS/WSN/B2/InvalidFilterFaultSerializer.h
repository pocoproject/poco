//
// InvalidFilterFaultSerializer.h
//
// Package: Generated
...
#ifndef TypeSerializer_OASIS_WSN_B2_InvalidFilterFault_INCLUDED
#define TypeSerializer_OASIS_WSN_B2_InvalidFilterFault_INCLUDED
...
template <>
class TypeSerializer<OASIS::WSN::B2::InvalidFilterFault>
{
public:
	static void serialize(const std::string& name, const OASIS::WSN::B2::InvalidFilterFault& value, Serializer& ser)
	{
	...
	static void serializeImpl(const OASIS::WSN::B2::InvalidFilterFault& value, Serializer& ser)
	{
		using namespace std::string_literals;
		...
		static const std::string REMOTING__NAMES[] = {"UnknownFilter"s,""s};
		TypeSerializer<std::vector<std::string>>::serialize(REMOTING__NAMES[0], value.getUnknownFilter(), ser);
	}
...
#endif // TypeSerializer_OASIS_WSN_B2_InvalidFilterFault_INCLUDED
