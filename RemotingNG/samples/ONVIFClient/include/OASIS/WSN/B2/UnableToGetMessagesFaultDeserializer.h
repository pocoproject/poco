//
// UnableToGetMessagesFaultDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_OASIS_WSN_B2_UnableToGetMessagesFault_INCLUDED
#define TypeDeserializer_OASIS_WSN_B2_UnableToGetMessagesFault_INCLUDED
...
template <>
class TypeDeserializer<OASIS::WSN::B2::UnableToGetMessagesFault>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, OASIS::WSN::B2::UnableToGetMessagesFault& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, OASIS::WSN::B2::UnableToGetMessagesFault& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_OASIS_WSN_B2_UnableToGetMessagesFault_INCLUDED
