//
// UnsupportedPolicyRequestFaultDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_OASIS_WSN_B2_UnsupportedPolicyRequestFault_INCLUDED
#define TypeDeserializer_OASIS_WSN_B2_UnsupportedPolicyRequestFault_INCLUDED
...
template <>
class TypeDeserializer<OASIS::WSN::B2::UnsupportedPolicyRequestFault>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, OASIS::WSN::B2::UnsupportedPolicyRequestFault& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, OASIS::WSN::B2::UnsupportedPolicyRequestFault& value)
	{
		using namespace std::string_literals;
		...
		static const std::string REMOTING__NAMES[] = {"UnsupportedPolicy"s};
		bool ret = false;
		std::vector<std::string> gen_unsupportedPolicy;
		ret = TypeDeserializer<std::vector<std::string>>::deserialize(REMOTING__NAMES[0], false, deser, gen_unsupportedPolicy);
		if (ret) value.setUnsupportedPolicy(gen_unsupportedPolicy);
	}
...
#endif // TypeDeserializer_OASIS_WSN_B2_UnsupportedPolicyRequestFault_INCLUDED
