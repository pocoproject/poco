//
// UnacceptableInitialTerminationTimeFaultSerializer.h
//
// Package: Generated
...
#ifndef TypeSerializer_OASIS_WSN_B2_UnacceptableInitialTerminationTimeFault_INCLUDED
#define TypeSerializer_OASIS_WSN_B2_UnacceptableInitialTerminationTimeFault_INCLUDED
...
template <>
class TypeSerializer<OASIS::WSN::B2::UnacceptableInitialTerminationTimeFault>
{
public:
	static void serialize(const std::string& name, const OASIS::WSN::B2::UnacceptableInitialTerminationTimeFault& value, Serializer& ser)
	{
	...
	static void serializeImpl(const OASIS::WSN::B2::UnacceptableInitialTerminationTimeFault& value, Serializer& ser)
	{
		using namespace std::string_literals;
		...
		static const std::string REMOTING__NAMES[] = {"MinimumTime"s,"MaximumTime"s,""s};
		ser.pushProperty(SerializerBase::PROP_XSDTYPE, "dateTime"s);
		TypeSerializer<Poco::DateTime>::serialize(REMOTING__NAMES[0], value.getMinimumTime(), ser);
		ser.popProperty(SerializerBase::PROP_XSDTYPE);
		ser.pushProperty(SerializerBase::PROP_XSDTYPE, "dateTime"s);
		TypeSerializer<Poco::Optional<Poco::DateTime>>::serialize(REMOTING__NAMES[1], value.getMaximumTime(), ser);
		ser.popProperty(SerializerBase::PROP_XSDTYPE);
	}
...
#endif // TypeSerializer_OASIS_WSN_B2_UnacceptableInitialTerminationTimeFault_INCLUDED
