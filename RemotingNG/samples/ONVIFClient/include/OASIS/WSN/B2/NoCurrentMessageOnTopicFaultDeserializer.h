//
// NoCurrentMessageOnTopicFaultDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_OASIS_WSN_B2_NoCurrentMessageOnTopicFault_INCLUDED
#define TypeDeserializer_OASIS_WSN_B2_NoCurrentMessageOnTopicFault_INCLUDED
...
template <>
class TypeDeserializer<OASIS::WSN::B2::NoCurrentMessageOnTopicFault>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, OASIS::WSN::B2::NoCurrentMessageOnTopicFault& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, OASIS::WSN::B2::NoCurrentMessageOnTopicFault& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_OASIS_WSN_B2_NoCurrentMessageOnTopicFault_INCLUDED
