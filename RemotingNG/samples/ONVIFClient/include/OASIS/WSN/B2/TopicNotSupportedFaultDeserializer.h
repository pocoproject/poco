//
// TopicNotSupportedFaultDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_OASIS_WSN_B2_TopicNotSupportedFault_INCLUDED
#define TypeDeserializer_OASIS_WSN_B2_TopicNotSupportedFault_INCLUDED
...
template <>
class TypeDeserializer<OASIS::WSN::B2::TopicNotSupportedFault>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, OASIS::WSN::B2::TopicNotSupportedFault& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, OASIS::WSN::B2::TopicNotSupportedFault& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_OASIS_WSN_B2_TopicNotSupportedFault_INCLUDED
