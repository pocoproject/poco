//
// UnacceptableTerminationTimeFaultSerializer.h
//
// Package: Generated
...
#ifndef TypeSerializer_OASIS_WSN_B2_UnacceptableTerminationTimeFault_INCLUDED
#define TypeSerializer_OASIS_WSN_B2_UnacceptableTerminationTimeFault_INCLUDED
...
template <>
class TypeSerializer<OASIS::WSN::B2::UnacceptableTerminationTimeFault>
{
public:
	static void serialize(const std::string& name, const OASIS::WSN::B2::UnacceptableTerminationTimeFault& value, Serializer& ser)
	{
	...
	static void serializeImpl(const OASIS::WSN::B2::UnacceptableTerminationTimeFault& value, Serializer& ser)
	{
		using namespace std::string_literals;
...
#endif // TypeSerializer_OASIS_WSN_B2_UnacceptableTerminationTimeFault_INCLUDED
