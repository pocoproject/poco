...
#ifndef TypeDeserializer_OASIS_WSN_B2_RenewResponse_INCLUDED
#define TypeDeserializer_OASIS_WSN_B2_RenewResponse_INCLUDED
...
template <>
class TypeDeserializer<OASIS::WSN::B2::RenewResponse>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, OASIS::WSN::B2::RenewResponse& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, OASIS::WSN::B2::RenewResponse& value)
	{
		using namespace std::string_literals;
		
		static const std::string REMOTING__NAMES[] = {"TerminationTime"s,"CurrentTime"s};
		bool ret = false;
...
#endif // TypeDeserializer_OASIS_WSN_B2_RenewResponse_INCLUDED
