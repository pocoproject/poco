//
// UnableToDestroyPullPointFaultDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_OASIS_WSN_B2_UnableToDestroyPullPointFault_INCLUDED
#define TypeDeserializer_OASIS_WSN_B2_UnableToDestroyPullPointFault_INCLUDED
...
template <>
class TypeDeserializer<OASIS::WSN::B2::UnableToDestroyPullPointFault>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, OASIS::WSN::B2::UnableToDestroyPullPointFault& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, OASIS::WSN::B2::UnableToDestroyPullPointFault& value)
	{
		using namespace std::string_literals;
...
#endif // TypeDeserializer_OASIS_WSN_B2_UnableToDestroyPullPointFault_INCLUDED
