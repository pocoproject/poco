//
// InvalidFilterFaultDeserializer.h
//
// Package: Generated
...
#ifndef TypeDeserializer_OASIS_WSN_B2_InvalidFilterFault_INCLUDED
#define TypeDeserializer_OASIS_WSN_B2_InvalidFilterFault_INCLUDED
...
template <>
class TypeDeserializer<OASIS::WSN::B2::InvalidFilterFault>
{
public:
	static bool deserialize(const std::string& name, bool isMandatory, Deserializer& deser, OASIS::WSN::B2::InvalidFilterFault& value)
	{
	...
	static void deserializeImpl(Deserializer& deser, OASIS::WSN::B2::InvalidFilterFault& value)
	{
		using namespace std::string_literals;
		...
		static const std::string REMOTING__NAMES[] = {"UnknownFilter"s};
		bool ret = false;
		std::vector<std::string> gen_unknownFilter;
		ret = TypeDeserializer<std::vector<std::string>>::deserialize(REMOTING__NAMES[0], true, deser, gen_unknownFilter);
		if (ret) value.setUnknownFilter(gen_unknownFilter);
	}
...
#endif // TypeDeserializer_OASIS_WSN_B2_InvalidFilterFault_INCLUDED
