...
const std::string Transport::PROTOCOL("http");
const std::string Transport::USER_AGENT("User-Agent");
const std::string Transport::CONTENT_TYPE("application/octet-stream");
...
void Transport::prepareRequest(Poco::Net::HTTPRequest& request)
{
