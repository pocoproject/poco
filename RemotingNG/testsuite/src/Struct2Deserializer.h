...
public:
	...
	static void deserializeImpl(Deserializer& deser, Struct2& value)
	{
		...
		static const std::string REMOTING__NAMES[] = {"aVector"s,"anotherVector"s,"anURI"s,"anUUID"s,"anULID"s,"aDateTime"s,"aLocalDateTime"s,"aTimestamp"s};
		...
		TypeDeserializer<Poco::ULID>::deserialize(REMOTING__NAMES[4], true, deser, value.anULID);
		TypeDeserializer<Poco::DateTime>::deserialize(REMOTING__NAMES[5], true, deser, value.aDateTime);
		TypeDeserializer<Poco::LocalDateTime>::deserialize(REMOTING__NAMES[6], true, deser, value.aLocalDateTime);
		TypeDeserializer<Poco::Timestamp>::deserialize(REMOTING__NAMES[7], true, deser, value.aTimestamp);
	}
