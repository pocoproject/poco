...
class TesterSetCookieMethodHandler: public Poco::RemotingNG::MethodHandler
{
public:
	void invoke(Poco::RemotingNG::ServerTransport& remoting__trans, Poco::RemotingNG::Deserializer& remoting__deser, Poco::RemotingNG::RemoteObject::Ptr remoting__pRemoteObject)
	{
		...
		static const std::string REMOTING__NAMES[] = {"setCookie"s};
		...
		try
		{
			...
			static const std::string REMOTING__REPLY_NAME("setCookieReply");
		...
		catch (const Poco::Exception& e)
		{
			...
			{
				remoting__trans.reportException("Tester::setCookie"s, e);
		...
		catch (const std::exception& e)
		{
			if (!remoting__requestSucceeded)
			{
				...
				remoting__trans.reportException("Tester::setCookie"s, exc);
				Poco::RemotingNG::Serializer& remoting__ser = remoting__trans.sendReply(Poco::RemotingNG::SerializerBase::MESSAGE_FAULT);
...
class TesterVerifyCookieMethodHandler: public Poco::RemotingNG::MethodHandler
{
public:
	void invoke(Poco::RemotingNG::ServerTransport& remoting__trans, Poco::RemotingNG::Deserializer& remoting__deser, Poco::RemotingNG::RemoteObject::Ptr remoting__pRemoteObject)
	{
		...
		static const std::string REMOTING__NAMES[] = {"verifyCookie"s};
		bool remoting__requestSucceeded = false;
		try
		{
			remoting__deser.pushProperty(Poco::RemotingNG::SerializerBase::PROP_NAMESPACE, TesterSkeleton::DEFAULT_NS);
			...
			remoting__deser.popProperty(Poco::RemotingNG::SerializerBase::PROP_NAMESPACE);
			TesterRemoteObject* remoting__pCastedRO = static_cast<TesterRemoteObject*>(remoting__pRemoteObject.get());
			bool remoting__return = remoting__pCastedRO->verifyCookie();
			remoting__requestSucceeded = true;
			Poco::RemotingNG::Serializer& remoting__ser = remoting__trans.sendReply(Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
			remoting__ser.pushProperty(Poco::RemotingNG::SerializerBase::PROP_NAMESPACE, TesterSkeleton::DEFAULT_NS);
			static const std::string REMOTING__REPLY_NAME("verifyCookieReply");
			remoting__ser.serializeMessageBegin(REMOTING__REPLY_NAME, Poco::RemotingNG::SerializerBase::MESSAGE_REPLY);
		...
		catch (const Poco::Exception& e)
		{
			if (!remoting__requestSucceeded)
			{
				remoting__trans.reportException("Tester::verifyCookie"s, e);
				Poco::RemotingNG::Serializer& remoting__ser = remoting__trans.sendReply(Poco::RemotingNG::SerializerBase::MESSAGE_FAULT);
				remoting__ser.serializeFaultMessage(REMOTING__NAMES[0], e);
			}
		}
		catch (const std::exception& e)
		{
			...
			{
				const Poco::Exception exc(e.what());
				remoting__trans.reportException("Tester::verifyCookie"s, exc);
				Poco::RemotingNG::Serializer& remoting__ser = remoting__trans.sendReply(Poco::RemotingNG::SerializerBase::MESSAGE_FAULT);
				remoting__ser.serializeFaultMessage(REMOTING__NAMES[0], exc);
			}
		}
...

{
	...
	addMethodHandler("setCookie"s, new TesterSetCookieMethodHandler);
	...
	addMethodHandler("verifyCookie"s, new TesterVerifyCookieMethodHandler);
}
