...
{
public:
	static constexpr int JSON_FMT_MODE_SMALL        = 1;
	static constexpr int JSON_FMT_MODE_ROW_COUNT    = 2;
	static constexpr int JSON_FMT_MODE_COLUMN_NAMES = 4;
	static constexpr int JSON_FMT_MODE_FULL         = 8;
