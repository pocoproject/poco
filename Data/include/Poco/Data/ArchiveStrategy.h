...
public:
	...
	[[nodiscard]] virtual const std::string& getThreshold() const = 0;
...
protected:
	...
	[[nodiscard]] Statement& getCopyStatement();
	[[nodiscard]] Statement& getDeleteStatement();
	[[nodiscard]] Statement& getCountStatement();
private:
