...
{
	poco_check_ptr (_pDB);
	return new SQLiteBDBStatementImpl(*this, _pDB);
}
...
void SessionImpl::begin()
{
	...
	SQLiteBDBStatementImpl tmp(*this, _pDB);
...
void SessionImpl::autoCommit(const std::string&, bool)
{
	...
	throw NotImplementedException(
		"SQLiteBDB autocommit is implicit with begin/commit/rollback.");
}
