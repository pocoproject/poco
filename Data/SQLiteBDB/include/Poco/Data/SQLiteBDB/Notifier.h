...
#ifndef SQLiteBDB_Notifier_INCLUDED
#define SQLiteBDB_Notifier_INCLUDED
...
class SQLiteBDB_API Notifier
	/// Notifier is a wrapper for SQLiteBDB callback calls. It supports event callbacks
...
public:
	...
	static int sqliteCommitCallbackFn(void* pVal);
		...
		/// non-zero value is returned, which causes SQLiteBDB engine to turn commit into a rollback.
...
#endif // SQLiteBDB_Notifier_INCLUDED
