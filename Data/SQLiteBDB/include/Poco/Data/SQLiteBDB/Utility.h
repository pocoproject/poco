...
#ifndef SQLiteBDB_Utility_INCLUDED
#define SQLiteBDB_Utility_INCLUDED
...
class SQLiteBDB_API Utility
	/// Various utility functions for SQLiteBDB.
{
public:
	...
	static bool isThreadSafe();
		/// Returns true if SQLiteBDB was compiled in multi-thread or serialized mode.
	...
	class SQLiteBDBMutex
	{
	public:
		SQLiteBDBMutex(sqlite3* pDB);
		~SQLiteBDBMutex();
...
private:
	Utility();
		/// Maps SQLiteBDB column declared types to Poco::Data types through
		/// static TypeMap member.
		/// 
		/// Note: SQLiteBDB is type-agnostic and it is the end-user responsibility
...
#endif // SQLiteBDB_Utility_INCLUDED
