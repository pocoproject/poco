...
#ifndef Data_SQLiteBDB_Extractor_INCLUDED
#define Data_SQLiteBDB_Extractor_INCLUDED
...
class SQLiteBDB_API Extractor: public Poco::Data::AbstractExtractor
	/// Extracts and converts data values form the result row returned by SQLiteBDB.
...
public:
	...
	bool isNull(std::size_t pos, std::size_t row = POCO_DATA_INVALID_ROW);
		...
		/// underlying database values due to the nature of SQLiteBDB engine,
		/// (once null value is converted to default value, SQLiteBDB API
...
#endif // Data_SQLiteBDB_Extractor_INCLUDED
