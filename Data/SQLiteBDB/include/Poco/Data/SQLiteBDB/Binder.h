...
#ifndef Data_SQLiteBDB_Binder_INCLUDED
#define Data_SQLiteBDB_Binder_INCLUDED
...
class SQLiteBDB_API Binder: public Poco::Data::AbstractBinder
...
private:
	void checkReturn(int rc);
		/// Checks the SQLiteBDB return code and throws an appropriate exception
...
#endif // Data_SQLiteBDB_Binder_INCLUDED
