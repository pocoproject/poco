//
// SQLiteBDBStatementImpl.h
//
// Library: Data/SQLiteBDB
// Package: SQLiteBDB
// Module:  SQLiteBDBStatementImpl
//
// Definition of the SQLiteBDBStatementImpl class.
//
...
#ifndef Data_SQLiteBDB_SQLiteBDBStatementImpl_INCLUDED
#define Data_SQLiteBDB_SQLiteBDBStatementImpl_INCLUDED


#include "Poco/Data/SQLiteBDB/SQLite.h"
#include "Poco/Data/SQLiteBDB/Binder.h"
#include "Poco/Data/SQLiteBDB/Extractor.h"
...
class SQLiteBDB_API SQLiteBDBStatementImpl: public Poco::Data::StatementImpl
	/// Implements statement functionality needed for SQLiteBDB
{
public:
	SQLiteBDBStatementImpl(Poco::Data::SessionImpl& rSession, sqlite3* pDB);
		/// Creates the SQLiteBDBStatementImpl.

	~SQLiteBDBStatementImpl();
		/// Destroys the SQLiteBDBStatementImpl.
...
protected:
	...
	void compileImpl();
		...
		/// The way SQLiteBDB handles batches of statmeents is by compiling
...
// inlines
//
inline AbstractExtraction::ExtractorPtr SQLiteBDBStatementImpl::extractor()
{
	return _pExtractor;
}


inline AbstractBinding::BinderPtr SQLiteBDBStatementImpl::binder()
{
	return _pBinder;
}


inline bool SQLiteBDBStatementImpl::canBind() const
{
	return _canBind;
}


inline bool SQLiteBDBStatementImpl::canCompile() const
{
	return _canCompile;
}
...
#endif // Data_SQLiteBDB_SQLiteBDBStatementImpl_INCLUDED
