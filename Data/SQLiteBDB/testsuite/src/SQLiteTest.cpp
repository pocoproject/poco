...
#include "Poco/Data/SQLiteBDB/Utility.h"
#include "Poco/Data/SQLiteBDB/Notifier.h"
#include "Poco/Data/SQLiteBDB/Connector.h"
...
using Poco::Data::SQLiteBDB::Notifier;
using Poco::Nullable;
using Poco::Tuple;
using Poco::Any;
using Poco::AnyCast;
...
using Poco::Data::SQLiteBDB::ConstraintViolationException;
using Poco::Data::SQLiteBDB::ParameterCountMismatchException;
using Poco::Int32;
using Poco::Int64;
using Poco::Dynamic::Var;
using Poco::Data::SQLiteBDB::Utility;
using Poco::delegate;
...
public:
	...
	{
		// no-op (SQLiteBDB is prepare-less connector)
	}
...
{
	Poco::Data::SQLiteBDB::Connector::registerConnector();
}


SQLiteTest::~SQLiteTest()
{
	Poco::Data::SQLiteBDB::Connector::unregisterConnector();
}


void SQLiteTest::testBinding()
{
	Session tmp (Poco::Data::SQLiteBDB::Connector::KEY, "dummy.db");
...
void SQLiteTest::testInMemory()
{
	...
	Session mem (Poco::Data::SQLiteBDB::Connector::KEY, ":memory:");
	assertTrue (Poco::Data::SQLiteBDB::Utility::fileToMemory(mem, "dummy.db"));
	...
	Session dsk (Poco::Data::SQLiteBDB::Connector::KEY, "dsk.db");
	assertTrue (Poco::Data::SQLiteBDB::Utility::memoryToFile("dsk.db", mem));
...
{
	Session ses (Poco::Data::SQLiteBDB::Connector::KEY, "dummy.db");
...
void SQLiteTest::testSQLChannel()
{
	...
	AutoPtr<SQLChannel> pChannel = new SQLChannel(Poco::Data::SQLiteBDB::Connector::KEY, "dummy.db", "TestSQLChannel");
...
{
	Session session (Poco::Data::SQLiteBDB::Connector::KEY, "dummy.db");
...
{
	using namespace Poco::Data::SQLiteBDB;
...
void SQLiteTest::testSessionTransaction()
{
	...
	Session local (Poco::Data::SQLiteBDB::Connector::KEY, "dummy.db");
...
void SQLiteTest::testIllegalFilePath()
{
	try
	{
		Session tmp(Poco::Data::SQLiteBDB::Connector::KEY, "\\/some\\/illegal\\/path\\/dummy.db", 1);
		fail("must fail");
	}
