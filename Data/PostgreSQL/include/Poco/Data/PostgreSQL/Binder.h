...
public:
	...
	virtual ~Binder() override;
		/// Destroys the Binder.

	virtual void bind(std::size_t pos, const Poco::Int8& val, Direction dir = PD_IN) override;
		/// Binds an Int8.

	virtual void bind(std::size_t pos, const Poco::UInt8& val, Direction dir = PD_IN) override;
		/// Binds an UInt8.

	virtual void bind(std::size_t pos, const Poco::Int16& val, Direction dir = PD_IN) override;
		/// Binds an Int16.

	virtual void bind(std::size_t pos, const Poco::UInt16& val, Direction dir = PD_IN) override;
		/// Binds an UInt16.

	virtual void bind(std::size_t pos, const Poco::Int32& val, Direction dir = PD_IN) override;
		/// Binds an Int32.
	...
	void bind(std::size_t pos, const Poco::Data::BLOB& val, Direction dir = PD_IN) override;
		/// Binds a BLOB.

	void bind(std::size_t pos, const Poco::Data::CLOB& val, Direction dir = PD_IN) override;
		/// Binds a CLOB.
	...
	[[nodiscard]] InputParameterVector bindVector() const;
