...
/*
	...
	First, we tried call mysql_refresh() (now obsolete) and mysql_reset_connection(). Both of
	these functions caused unintended reseting of variables hoding charset/encoding (internal variables
