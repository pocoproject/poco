...
// WebWidgets.h
//
// $Id: //poco/Main/WebWidgets/include/Poco/WebWidgets/WebWidgets.h#6 $
//
// Library: WebWidgets
// Package: Core
// Module:  WebWidgets
//
// Basic definitions for the WebWidgets library.
...
//
// Automatically link WebWidgets library.
//
#if defined(_MSC_VER)
	#if !defined(POCO_NO_AUTOMATIC_LIBS) && !defined(WebWidgets_EXPORTS)
		#if defined(POCO_DLL)
			#if defined(_DEBUG)
				#pragma comment(lib, "PocoWebWidgetsd.lib")
			#else
				#pragma comment(lib, "PocoWebWidgets.lib")
			#endif
		#else
			#if defined(_DEBUG)
				#pragma comment(lib, "PocoWebWidgetsmtd.lib")
			#else
				#pragma comment(lib, "PocoWebWidgetsmt.lib")
			#endif
		#endif
	#endif
#endif
