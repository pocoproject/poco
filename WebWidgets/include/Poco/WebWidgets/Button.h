...
class WebWidgets_API Button: public Control
...
protected:
	...
	Button(const std::string& name, const std::type_info& type, Cell::Ptr ptrCell);
		/// Creates a Button and assigns it the given name.

	Button(const std::type_info& type, Cell::Ptr ptrCell);
		/// Creates a Button.
