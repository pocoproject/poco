...
// NumberField.cpp
//
// $Id: //poco/Main/WebWidgets/src/NumberField.cpp#2 $
//
// Library: WebWidgets
// Package: Controls
// Module:  NumberField
...
NumberField::NumberField(const std::string& name, const std::type_info& type):
	TextField(name, type, new NumberFieldCell(this))
{
}
