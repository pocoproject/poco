...
// PasswordField.cpp
//
// $Id: //poco/Main/WebWidgets/src/PasswordField.cpp#2 $
//
// Library: WebWidgets
// Package: Controls
...
PasswordField::PasswordField(const std::string& name, const std::type_info& type):
	TextField(name, type, new PasswordFieldCell(this))
{
}
