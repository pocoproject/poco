...
rem Change POSTGRESQL_DIR to match your setup
set POSTGRESQL_DIR=C:\PROGRA~1\POSTGR~1\9.3
set POSTGRESQL_INCLUDE=%POSTGRESQL_DIR%\include
set POSTGRESQL_LIB=%POSTGRESQL_DIR%\lib
set INCLUDE=%INCLUDE%;%POSTGRESQL_INCLUDE%
set LIB=%LIB%;%POSTGRESQL_LIB%
