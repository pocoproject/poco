...
# Standard 'must be' defines
  if (APPLE)
    ...
    if (QNX)
      add_definitions(-DPOCO_HAVE_FD_POLL -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64)
      set(SYSLIBS  m socket)
    else (QNX)
      add_definitions(-D_XOPEN_SOURCE=500)
      if (CYGWIN)
	    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wa,-mbig-obj")
	    add_definitions(-DPOCO_HAVE_FD_POLL -D__BSD_VISIBLE)
	  else (CYGWIN)
       add_definitions(-DPOCO_HAVE_FD_EPOLL -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64)
 	  endif (CYGWIN)
