...
$(warning Please build Poco with CMake)
...
.PHONY: poco all libexecs cppunit cpptrace tests samples cleans clean distclean install uninstall
...
ifdef POCO_ENABLE_TRACE
	$(MAKE) -C $(POCO_BASE)/dependencies/cpptrace
endif

cpptrace-clean:
ifdef POCO_ENABLE_TRACE
	$(MAKE) -C $(POCO_BASE)/dependencies/cpptrace clean
endif
